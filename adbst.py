# -*- coding: utf-8 -*-
"""
Created on Fri Jun 16 11:33:55 2017
...
if __name__=='__main__':
    ...
    submission_df = pd.DataFrame(data = {'PassengerId':ids["PassengerId"],'Survived':result})
    print (submission_df.head(10))
    submission_df.to_csv('submission_abbst.csv',columns = ['PassengerId','Survived'],index = False)
    print ('Done')